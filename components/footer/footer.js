...
export default function Footer() {
  ...
  return ( <footer className="text-center lg:text-left bg-[#0e46af] text-[#fff]">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8  flex justify-center items-center lg:justify-between p-6 border-b border-gray-100">
    <div className="mr-12 hidden lg:block">
      <span>Conecta con nosotros en las redes sociales:</span>
    </div>
    <div className="flex justify-center">
      <a href="#!" className="mr-6 text-[#fff]">
  ...
  <div className="text-center p-6 bg-[#0e46af]">
    <span>© 2022 Copyright:</span>
    <a className="text-[#fff] font-semibold" href="#">PADEL CLUB</a>
  </div>
</footer>
  )
}
